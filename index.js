...
const raised = GAMES_JSON.reduce((sum, game) => sum + game.pledged, 0);
const totalGames = GAMES_JSON.length;
const display = `A total of ${raised.toLocaleString()} has been raised for ${totalGames} game${totalGames > 1 ? 's' : ''}. Currently, ${unfundedGames.length} game${unfundedGames.length > 1 ? 's' : ''} remain unfunded. We need your help to fund these amazing projects!`;
